...
<!-- forge role skill — generated from .claude/agents/council-seat.md (body verbatim).
Kimi Code CLI has no custom sub-agent registry (built-ins: coder / explore / plan), so
forge's DVRR roles ship as project skills: invoke as /skill:council-seat, or dispatch a
