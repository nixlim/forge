...
<!-- forge: removed upstream MockServer-specific content: routing rows for the pipeline-investigation (Buildkite) and aws-investigation ops skills, which are not installed -->
<!-- FORGE:REGION conversational-routing BEGIN -->
| Skill | Subagent Type | Typical Requests |
|-------|---------------|------------------|
| `review-code` | `review-cheap` | "review this change", "audit this diff" |
| `review-spec` | `review-final` | "review this spec", "red-team this design" |
<!-- forge-init: add rows for any project-specific investigation/ops skills this repo gains; keep routing policy here, not in skill descriptions -->
<!-- FORGE:REGION conversational-routing END -->
