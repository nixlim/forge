---
name: test-runner
description: Runs tests for changed modules and reports results. Spawn this agent to execute targeted tests after code changes — it maps changed directories to modules and runs only what's needed.
model: opus
effort: low
tools:
  - Read
