---
name: implementer
description: Implementation specialist — writes production code and tests following {{FORGE_PROJECT_NAME}} conventions. Spawn this agent to implement features from a spec or plan. It reads existing patterns, writes code, runs tests, and reports results.
model: fable
effort: high
---
