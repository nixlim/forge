...
description: Security-focused code auditor. Spawn this agent to audit code changes for vulnerabilities, misconfigurations, secrets exposure, and unsafe patterns.
model: fable
effort: high
tools:
  - Read
