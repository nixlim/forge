---
name: code-reviewer
description: Pre-commit code reviewer — checks for correctness, security, and {{FORGE_PROJECT_NAME}} conventions. Spawn this agent when you need a focused review of staged/unstaged changes before committing.
model: opus
effort: medium
tools:
  - Read
